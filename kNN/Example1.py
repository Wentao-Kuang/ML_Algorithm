...
'''
Dating data set classification Example,
Using datingTestSet2 as the training data.
@author: Wentao Kuang
'''
...
def plotScatter():
    ...
    group, labels = kNN.file2matrix('/Users/kuangwentao/PycharmProjects/ML_Algorithm/DataSets/datingTestSet.txt', 3)
...
def errorTest():
    ...
    group, lables = kNN.file2matrix('/Users/kuangwentao/PycharmProjects/ML_Algorithm/DataSets/datingTestSet2.txt', 3)
...
def kNNclassifier():
    ...
    group, lables = kNN.file2matrix('/Users/kuangwentao/PycharmProjects/ML_Algorithm/DataSets/datingTestSet.txt', 3)
